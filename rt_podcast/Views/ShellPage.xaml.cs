...
namespace rt_podcast.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<EpisodesPage>("Shell_Episodes".GetLocalized(), Symbol.Document));
            _secondaryItems.Add(ShellNavigationItem.FromType<SettingsPage>("Shell_Settings".GetLocalized(), Symbol.Setting));
            _primaryItems.Add(ShellNavigationItem.FromType<WebsitePage>("Shell_Website".GetLocalized(), Symbol.Document));
        }
