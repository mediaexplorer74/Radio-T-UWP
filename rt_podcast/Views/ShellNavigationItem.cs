...
namespace rt_podcast.Views
{
    public class ShellNavigationItem : INotifyPropertyChanged
    {
        ...
        public bool IsSelected
        {
            ...
            set
            {
                ...
                SelectedForeground = value
                    ? Application.Current.Resources["SystemControlForegroundAccentBrush"] 
                    as SolidColorBrush
        ...
        {
            var result = Application.Current.Resources["SystemControlForegroundBaseHighBrush"] 
                as SolidColorBrush;

            if (!Services.ThemeSelectorService.IsLightThemeEnabled)
            {
                result = Application.Current.Resources["SystemControlForegroundAltHighBrush"] 
                    as SolidColorBrush;
            }
        ...
        private ShellNavigationItem(string name, Symbol symbol, Type pageType)
        {
            ...
            Services.ThemeSelectorService.OnThemeChanged += (s, e) 
                => { if (!IsSelected) SelectedForeground = GetStandardTextColorBrush(); };
        }
